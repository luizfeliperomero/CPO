...
public class VersionController {
    List<Version> versions = Arrays.asList(new Version(VersionNumber.V2_2_1, new URL("http://localhost:8092/ocpi/cpo/versions/2.2.1/details")));
    ...
    public ResponseEntity<List<VersionDetails>> getVersionsDetails() {
        ...
        new Endpoint(ModuleID.credentials,
                ...
                new URL("http://localhost:8092/2.2.1/credentials")));
